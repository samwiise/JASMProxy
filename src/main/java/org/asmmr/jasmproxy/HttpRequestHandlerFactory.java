 ...
 *
 */
public class HttpRequestHandlerFactory extends RequestHandlerFactory {

	@Override
	public IRequestHandler create(SocketChannel client,
			SocketEventEngine eventengine, IRequestHandlerContainer container)throws IOException {
		// TODO Auto-generated method stub
		return new HttpRequestHandler(client,eventengine,container);
	}
